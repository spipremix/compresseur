...
### - Fichier d'origine : ../plugins/auto/compresseur/plugin.xml
...
# svn add lang/paquet-compresseur_fr.php
...
# svn mv compresseur_http.php compresseur_options.php
# svn mv filtres/compresseur.php compresseur_fonctions.php
